          ...
          <div class="row gx-4">
            ...
            <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
              <div class="nav-wrapper position-relative end-0">
                ...
                <a class=" btn btn-primary nav-item mb-0 px-0 py-2 d-flex align-items-center justify-content-center mx-5" href="{{ route('member_roomtype.index') }}">ຍອນກັບ</a>
...
<div class="card uper">
  <div class="card-header">
    ປ້ອນລາຍອ່ຽດໃຫ້ຄົບເພື່ອເພີ່ມປະເພດຫ້ອງແຖວ
  </div>
  <div class="card-body">
    @if ($errors->any())
    ...
    @endif
      ...
      <form method="post" action="{{ route('member_roomtype.store') }}">
          <div class="form-group">
              @csrf
              <label for="country_name">ປ້ອນປະເພດຫ້ອງແຖວ:</label>
