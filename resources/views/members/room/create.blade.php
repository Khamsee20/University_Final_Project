    ...
    <div class="container-fluid py-2">
                    ...
                    <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            ...
                            <a class=" btn btn-primary nav-item mb-0 px-0 py-2 d-flex align-items-center justify-content-center mx-5"
                                href="{{ route('member_register-room.index') }}">ຍອນກັບ</a>
        ...
        <div class="card uper">
            <div class="card-header">
                ປ້ອນຂໍ້ມູນຕາມຟອມນີ້ໃຫ້ຄົບຖວນເພື່ອລົງທະບຽນຫ້ອງແຖວ
            </div>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('member_register-room.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row mt-1">
                            <div class="col-lg-6 mb-lg-0">
                                <div class="card w-100">
                                    <div class="table-responsive m-0 px-2 ">
                                        ...
                                        {{-- <div class="progress-wrapper">
                                            ...
                                            <div class="text">
                                                <select name="member_id" class="textdorm w-100 py-2"
                                                    ...
                                                    @foreach ($memget as $member)
                                                     
                                                            <option style="color:#0fa034; pl-5" value="{{ $member->id }}">
                                                               {{ $member->users->name }} </option>
                            ...
                            <div class="col-lg-6 mb-lg-0 mb-4">
                                <div class="card w-100">
                                    <div class="table-responsive m-0 px-2">
                                        ...
                                        <label for="horm">ປ້ອນຈຳນວນຫ້ອງ:</label>
                ...
                @enderror
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary px-5 mt-4 mb-3 float-end ">ເພີ່ມ</button>
                                    </div>
                                </div>
                            </div>
