      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">ຍິນດີຕອນຮັບເຂົ້າສູ່ໜ້າລ໋ອກອິນ</h1>
            <p class="text-lead text-white">ກະລຸນະ ປ້ອນອີເມວ ແລະ ລະຫັດຜ່ານຂອງທ່ານເພື່ອເຂົ້າສູ່ລະບົບ</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                    <input id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="ປ້ອນອີເມວ......" required autocomplete="email" autofocus>
                ...
                <div class="mb-3">
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="ປ້ອນລະຫັດຜ່ານ......">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    <p class="mb-4 text-sm mx-auto">
                      ຖ້າທ່ານຍັງບໍ່ທັນມີບັນຊີໃຫ້ກົດ 
                      <a href="{{ route('register') }}" class="text-primary text-gradient font-weight-bold">ລົງທະບຽນ</a>
