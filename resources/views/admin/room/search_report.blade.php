        ...
        <div class="card-body p-2">
          <div class="row gx-4">
            ...
            <div class="col-auto my-4 ">
              <div class="h-100">
                <h4 class="mb-1">
                  ລາຍງານຫ້ອງແຖວຕາມວັນທີ ທີທ່ານກຳນົດມີທັງໝົດ {{ $c_roomget }} ຫ້ອງ
                </h4>
              </div>
        ...
        <div class="card mb-4">
          ...
          <div class="card-header p-0 ">
            <form action="{{ route('admin_room.search_report') }}" method="POST" class="mx-5 my-3">
              ...
              <p style="padding-right: 12rem;">
                  ...
                  <a class="asearch" title="ຣີເຟສ" href="{{ route('admin_room.report') }}"><span class="fas fa-sync-alt"></span></a>
              </p>
          </form>
          ...
          <div class="card-body px-3 pt-1 pb-2 ">
            <div class="table-responsive p-0">
              ...
              {{ $roomget->links('pagination::bootstrap-4') }}
