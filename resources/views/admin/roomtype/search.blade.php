      ...
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-header pb-0">
            ...
            <a class="btn btn-success float-end px-6 mx-2" href="{{ route('roomtype.create') }}">ເພີ່ມ</a>
            <a class="btn btn-primary float-end px-6 mx-2" href="{{ route('roomtype.index') }}">ຍອນກັບ</a>
