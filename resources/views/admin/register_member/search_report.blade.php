        ...
        <div class="card-body p-2">
          <div class="row gx-4">
            ...
            <div class="col-auto my-4 ">
              <div class="h-100">
                <h4 class="mb-1">
                  ລາຍງານສະມາຊິກຫ້ອງແຖວສະເພາະວັນທີ ທີ່ກຳນົດມີທັງໝົດ {{ $C_member }} ຄົນ
                </h4>
              </div>
      ...
      <div class="col-12">
        <div class="card mb-4">
          ...
          <div class="card-header p-0 ">
            <form action="{{ route('register_member.search_report') }}" method="POST" class="mx-5 my-3">
              @csrf
              <p style="padding-right: 12rem;">
                  ...
                  <a class="asearch" title="ຣີເຟສ" href="{{ route('register_member.report') }}"><span class="fas fa-sync-alt"></span></a>
              </p>
          </form>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-secondary font-weight-bolder opacity-10">ວັນທີ / ທີ່ສະໝັກເປັນສະມາຊິກ</th>
